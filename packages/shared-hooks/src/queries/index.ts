...
export { useAcademicSessions, useCreateAcademicSession, useUpdateAcademicSession } from './useAcademicSessions';
...
export { useCreateSpace, useUpdateSpace, usePublishSpace, useArchiveSpace, useDuplicateSpace } from './useSpaceMutations';
...
// Item mutation hooks
export { useCreateItem, useUpdateItem, useDeleteItem, useBulkCreateItems } from './useItemMutations';

// Exam mutation hooks
export { useCreateExam, useUpdateExam, usePublishExam } from './useExamMutations';

// Submission mutation hooks
export { useUploadAnswerSheets, useGradeQuestion, useReleaseResults } from './useSubmissionMutations';

// Progress mutation hooks
export { useRecordItemAttempt } from './useRecordItemAttempt';

// Single-entity detail hooks
export { useClass, useStudent, useTeacher, useParent, useItem, useSubmission } from './useEntityDetails';

// Achievement & Gamification hooks
export { useAchievements, useStudentAchievements, useStudentLevel, useStudyGoals } from './useAchievements';
