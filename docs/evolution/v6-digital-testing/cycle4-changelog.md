...
### New File
- `packages/shared-services/src/levelup/adaptive-engine.ts` — Pure-function adaptive question selection algorithm
...
### New File
- `apps/teacher-web/src/components/question-bank/QuestionBankEditor.tsx` — Full question editor sheet
...
- `@levelup/functions-levelup` — Pre-existing errors only (import-from-bank, list-question-bank, parse-request, rate-limit)
