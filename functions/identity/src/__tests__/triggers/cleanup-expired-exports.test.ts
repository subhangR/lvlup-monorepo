...
function makeFile(name: string, deleteAfter: string | undefined, opts?: { invalidDate?: boolean }) {
  return {
    name,
    metadata: {
...
describe("cleanupExpiredExports", () => {
  ...
  it("should delete files past their deleteAfter date", async () => {
    ...
    expect(logger.info).toHaveBeenCalledWith("Deleted expired export file: exports/creds-1.csv");
