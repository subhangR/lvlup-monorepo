 ...
 */
function buildTutorSystemPrompt(agent, item, studentAnswer, evaluationResult, language = 'english') {
...
function getSubjectGuidance(subject) {
    ...
    if (SUBJECT_GUIDANCE[normalized])
        return SUBJECT_GUIDANCE[normalized];
